<template>
    <div class="background">
        <userComponent />
        <titleComponent />
        <h1 class="mt-5 mb-4">Configurações</h1>
        <div class="col-10 col-md-7 col-lg-4 m-auto d-flex flex-column justify-content-between">
            <div>
                <div class="mb-3">
                    <label for="userName" class="form-label fs-4">Nome de usuário</label>
                    <input type="text" class="form-control fs-5" id="userName" readonly :value="name">
                    <button class="btn btn-light mt-4 fs-5 w-75">Alterar Nome de Usuário</button>
                </div>
                <div class="mb-3">
                    <label for="email" class="form-label fs-4">Email</label>
                    <input type="email" class="form-control fs-5" id="email" readonly :value="email">
                    <button class="btn btn-light mt-4 fs-5 w-75">Alterar Email</button>
                </div>
                <div class="mb-3">
                    <label class="form-label fs-4">Armazenamento</label>
                    <progressBarComponent 
                        ...
                        type="bg-success"
                    />
                    <button class="btn btn-light mt-4 fs-5 w-75">Alterar Plano de Armazenamento</button>
                </div>
            </div>
